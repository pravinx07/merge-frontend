    ...
    <section className="relative pt-32 pb-20 overflow-hidden">
      ...
      <div className="container mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center">
        <div className="z-10 text-center lg:text-left">
          ...
          >
            <button onClick={()=>navigate('/signup')} className="px-8 py-4 bg-brand-cyan text-dark-bg rounded-xl font-bold shadow-[0_0_20px_rgba(0,229,255,0.3)] hover:-translate-y-1 transition-all flex items-center gap-2 cursor-pointer">
              Meet Builders
              <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                <path d="M14 5l7 7m0 0l-7 7m7-7H3" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </button>
            <button onClick={()=>navigate('/signup')} className="px-8 py-4 border border-dark-border text-white rounded-xl font-bold hover:bg-white/5 transition-all cursor-pointer">
              Explore Developers
            </button>
          </motion.div>
