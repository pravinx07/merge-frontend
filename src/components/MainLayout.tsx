...
const MainLayout = ({ children }: { children: React.ReactNode }) => {
  ...
  const navItems = [
    ...
    { name: 'Messages', icon: MessageSquare, path: '/matches' }, // Points to matches for now
  ...
  return (
    <div className="min-h-screen bg-[#0A0A0B] text-white flex font-sans selection:bg-brand-cyan/30">
      {/* Sidebar ... (omitted for brevity in replacement, but I must include it) */}
                      ...
                      <div className="max-h-96 overflow-y-auto">
                        {notifications.length > 0 ? (
                          notifications.map((notif, idx) => (
                            ...
                            >
                              <div className="flex gap-3">
                                <img src={notif.sender.avatar || '/default-avatar.png'} className="w-8 h-8 rounded-full border border-white/10" alt="" />
                                <div>
                          ...
                          <div className="p-8 text-center">
                            ...
                            <p className="text-[10px] text-slate-600 font-bold uppercase tracking-widest">No new notifications</p>
                          </div>
                        )}
                      </div>
                    </motion.div>
