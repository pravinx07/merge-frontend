    ...
    <div className="min-h-screen bg-dark-bg flex items-center justify-center p-6 relative overflow-hidden">
      ...
      >
        <div className="text-center mb-10">
          ...
          <p className="text-slate-400 mt-2">Start your journey with developers worldwide.</p>
        </div>
        ...
        <div className="bg-dark-card/50 backdrop-blur-xl border border-dark-border p-8 rounded-[32px] shadow-2xl">
          ...
          <button className="w-full py-4 border border-dark-border text-white rounded-2xl font-bold hover:bg-white/5 transition-all flex items-center justify-center gap-3 cursor-pointer">
